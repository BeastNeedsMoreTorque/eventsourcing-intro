...
case class GameData(home: ClubData, away: ClubData)(val round: Int, val homeGoals: Int, val awayGoals: Int)

object GameData {
  def apply(game: Game) = new GameData(ClubData(game.home), ClubData(game.away))(game.round, game.homeGoals, game.awayGoals)
  ...
  implicit val gameDataReads: Reads[GameData] =
    ((JsPath \ "home").read[ClubData] and
      ...
      ) ((home: ClubData, away: ClubData, round: Int, homeGoals: Int, awayGoals: Int) => new GameData(home, away)(round, homeGoals, awayGoals))
}
